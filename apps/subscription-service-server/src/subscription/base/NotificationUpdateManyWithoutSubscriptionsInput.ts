...
@InputType()
class NotificationUpdateManyWithoutSubscriptionsInput {
...
export { NotificationUpdateManyWithoutSubscriptionsInput as NotificationUpdateManyWithoutSubscriptionsInput };
